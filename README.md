- This project is a Search Assistant Web App built using Flask for the backend and HTML, CSS, and JavaScript for the frontend and for backend Flask is Used.
